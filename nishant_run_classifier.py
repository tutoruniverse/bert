...
BERT_BASE_DIR = os.environ.get('BERT_BASE_DIR')
DATA_DIR = os.environ.get('DATA_DIR')
TRAINED_CLASSIFIER = os.environ.get('TRAINED_CLASSIFIER')
...
flags.DEFINE_string("task_name", "raw", "The name of the task to train.")
...
flags.DEFINE_bool(
    "raw_predict", True,
    "Predict similarity score given two questions"
)
...
class RawQPInputProcessor(DataProcessor):
    """Processor for raw string input"""
    def get_train_examples(self, data_dir):
        pass
